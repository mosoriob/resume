...
\begin{cventries}
  \cventry {Presenter for StarsConf} {DockerPedia: A knowledge graph of Docker Images.}
  ...
  \cventry {Presenter for SemSci 2018: Enabling Open Semantic Science}
  ...
  \cventry {Presenter for Security Talks UTFSM} {Docker security: Using Containers safely}
